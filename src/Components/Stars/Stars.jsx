...
export const Stars = () => {
  ...
  let [star, setStar] = useState([emptyStar,emptyStar,emptyStar,emptyStar,emptyStar]);
  ...
  return (
    <>
      <div className={style.star_block}>{star}
      <div className={style.star_btns}>
        {btns.map((el, ind) => (
          <button className={style.star_btn} id={ind + 1} onClick={scoreHandler}>
            {el}
          </button>
        ))}
        </div>
